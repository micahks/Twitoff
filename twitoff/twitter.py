"""Retrieve twees and users then create embeddingss and populate DB"""
...
def add_or_update_user(username):
    try:
        ...
        for tweet in tweets:
            # stores numberical representations
        ...
        # prints error t user and raises throughout app
